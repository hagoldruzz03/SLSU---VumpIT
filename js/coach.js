...
function setupEventListeners() {
    ...
    if (studentForm) {
        ...
        const bmiInput = document.getElementById('studentBMI');
...
function handleLogin(e) {
    ...
    const user = DataStore.getUserById(coachId);
    
    if (!user) {
        if (errorMsg) {
            errorMsg.textContent = 'Coach ID not found!';
            errorMsg.classList.add('active');
        }
        return;
    }
    ...
    if (user.user_type !== 'coach') {
        if (errorMsg) {
            errorMsg.textContent = 'This account is not a coach account!';
            errorMsg.classList.add('active');
        }
        return;
    }
...
function handleStudentSubmit(e) {
    ...
    const studentData = {
        ...
        // BMI Statistics
        current_weight: parseFloat(document.getElementById('studentWeight').value) || null,
        current_height: parseFloat(document.getElementById('studentHeight').value) || null,
        current_bmi: parseFloat(document.getElementById('studentBMI').value) || null,
        current_bmi_rating: document.getElementById('studentBMIRating').value,
        updated_bmi_date: document.getElementById('studentBMIDate').value,
        
        // Jump Height Statistics
        current_standing_reach: parseFloat(document.getElementById('studentStandingReach').value) || null,
        current_jump_reach: parseFloat(document.getElementById('studentJumpReach').value) || null,
        current_jump_height: parseFloat(document.getElementById('studentJumpHeight').value) || null,
        current_vertical_jump: parseFloat(document.getElementById('studentVerticalJump').value) || null,
        current_jump_rating: document.getElementById('studentJumpRating').value,
        updated_jump_date: document.getElementById('studentJumpDate').value,
        
        // Training Recommendations - Use form values (which may be auto-generated)
        training_focus: document.getElementById('studentTrainingFocus').value.trim(),
        plyometric: document.getElementById('studentPlyometric').value.trim(),
        recovery: document.getElementById('studentRecovery').value.trim(),
        remarks: document.getElementById('studentRemarks').value.trim()
    };
    
    if (editId) {
        // Get existing student to preserve history
        ...
        // Initialize empty history arrays for new students
